...
** Last update Fri Mar 11 21:52:21 2011 axel catusse
*/

#include <string.h>
#include "nm.h"

static void		swapptr(Elf64_Sym **symtab_cpy, int fst, int snd)
{
  Elf64_Sym		*t;
					...
					char *strsymtab)
{
  ...
  sort_by_ascii64(symtab_cpy, begin, right, strsymtab);
  sort_by_ascii64(symtab_cpy, right + 1, end, strsymtab);
}
